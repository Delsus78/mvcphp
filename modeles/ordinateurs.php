...
class Ordinateurs
{
    ...
    /**
     * R�cup�re tous les ordinateurs du parc
     */
    ...
    /**
     * R�cup�re l'oridnateur dont l'id est fourni
     * @param mixed $id Id de l'ordintateur � trouver
     * @return null|Ordinateur null ou Ordinateur r�cup�r�
     */
